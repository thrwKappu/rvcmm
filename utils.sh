...
get_prebuilts() {
	...
	local rv_integrations_filename=${RV_INTEGRATIONS_URL#"$TEMP_DIR/"}
	local rv_integrations_ver=${rv_integrations_filename##*'-'}
	log "Integrations: [$rv_integrations_filename](https://github.com/revanced/revanced-integrations/releases/tag/v${rv_integrations_ver%%'.apk'*})"
